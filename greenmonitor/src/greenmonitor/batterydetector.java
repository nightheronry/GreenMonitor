...
public interface batterydetector extends StdCallLibrary {


    public batterydetector INSTANCE = (batterydetector) Native.loadLibrary("batterydetector", batterydetector.class);
