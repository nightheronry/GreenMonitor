...
public class brokenline  {
	static DefaultCategoryDataset defaultcategorydataset=greenmonitor.green_monitor.staticdefaultcategorydataset;
    public brokenline() {
    ...
    private static CategoryDataset createDataset() {
        ...
        //defaultcategorydataset.addValue(504.0, "First", "1002.1");
        //defaultcategorydataset.addValue(1520.0, "First", "1083.2");
/*
        //图例2
...
/*
	...
	private static JFreeChart createChart(CategoryDataset categorydataset) {
        ...
        // 改变图表的背景颜色
        jfreechart.setBackgroundPaint(new Color(153, 255, 255));
